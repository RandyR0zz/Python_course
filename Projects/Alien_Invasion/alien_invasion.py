...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        #уничтожить исчезнувшие снаряды
    ...
    def _check_bullet_alien_collisions(self):    
        ...
        if not self.aliens:
            #уничтожить существующих снарядов, увеличить скорость и создать новый флот
            self.bullets.empty()
            self._create_fleet()
    ...
    def _ship_hit(self):
        """Обрабатывает столкновения корабоя с пришельцами"""
    ...
    def _update_aliens(self):
        ...
        #Проверка коллизий корабля с пришельцами
    ...
    def _create_alien(self, alien_number, row_number):
        """Создание пришельца и его размещение"""
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
    ...
    def _check_fleet_edges(self):
        """Проверяет, достигнут ли край экрана"""
    ...
    def _update_screen(self):
        self.screen.blit(self.settings.bg_img, self.settings.bg_img.get_rect())
